...
![shot-2026-02-06+05-05-44.jpeg](files/shot-2026-02-06+05-05-44.jpeg "shot-2026-02-06+05-05-44.jpeg")
...
viewof button_6 = Inputs.button("Fetch",{reduce:async ()=>{
  return await (await commonFetch(`/api/kuzu/query/${projectId}/default?query=match(n)-[r]-(m) return *`)).json()
        }})
```
...
viewof button_7 = Inputs.button("POST",{
  reduce:async () => { 
    return await fetch(`/api/kuzu/query/${projectId}/default`, {
      method: 'POST',
      headers: {
